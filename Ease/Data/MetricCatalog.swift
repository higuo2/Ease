...
enum MetricCatalog {
    ...
    static let builtins: [MetricSpec] = [
        cm("waist", title: "metric.waist", symbol: "arrow.down.to.line.compact", range: 40...200, order: 0),
        cm("hip", title: "metric.hip", symbol: "figure.stand.dress", range: 40...200, order: 1),
        ...
        cm("underbust", title: "metric.underbust", symbol: "lines.measurement.horizontal", range: 40...200, order: 4),
        cm("highWaist", title: "metric.highWaist", symbol: "arrow.up.to.line.compact", range: 40...200, order: 5),
        cm("navel", title: "metric.navel", symbol: "line.3.horizontal", range: 40...200, order: 6),
        cm("leftArm", title: "metric.leftArm", symbol: "hand.point.up.left.fill", range: 15...60, order: 7),
        cm("rightArm", title: "metric.rightArm", symbol: "hand.point.up.right.fill", range: 15...60, order: 8),
        cm("leftThigh", title: "metric.leftThigh", symbol: "figure.step.training", range: 20...120, order: 9),
        cm("leftCalf", title: "metric.leftCalf", symbol: "shoeprints.fill", range: 20...60, order: 10),
        cm("rightCalf", title: "metric.rightCalf", symbol: "shoeprints", range: 20...60, order: 11),
        cm("shoulderWidth", title: "metric.shoulderWidth", symbol: "arrow.left.and.right", range: 20...80, order: 12),
        cm("shoulder", title: "metric.shoulder", symbol: "tshirt.fill", range: 50...160, order: 13),
